...
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8 COMMENT='Admin Resource Table';

-- Dumping data for table nha_sach.jos_admin_resource: ~33 rows (approximately)
...
INSERT INTO `jos_admin_resource` (`resource_id`, `parent_id`, `resource`, `resource_name`, `resource_type`, `resource_object`, `is_white_list`, `is_hidden`) VALUES
	...
	(180, 161, 'createData', 'createData Action', 'Action', 'ACL', 0, 0),
...
) ENGINE=InnoDB AUTO_INCREMENT=470 DEFAULT CHARSET=utf8 COMMENT='Admin Rule Table';

-- Dumping data for table nha_sach.jos_admin_rule: ~64 rows (approximately)
